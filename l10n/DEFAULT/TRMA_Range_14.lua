...
local function range14_flag31()
    range_14_menu_flag31:Remove()
    trigger.action.setUserFlag(31, true)
    MessageToAll("R14 Rognan scenario activated")
end

local function range14_flag34()
    range_14_menu_flag34:Remove()
    trigger.action.setUserFlag(34, true)
    MessageToAll("R14 CAS scenario #1 activated")
end

range_14_menu_flag31 = MENU_MISSION_COMMAND:New("Activate R14 Rognan Scenario",range_14_menu_root,range14_flag31)
range_14_menu_flag34 = MENU_MISSION_COMMAND:New("Activate R14 CAS Scenario #1",range_14_menu_root,range14_flag34)
