...
local function range15_flag61()
  range_15_menu_flag61:Remove()
  trigger.action.setUserFlag(61, true)
  MessageToAll("R15 Basic CAS scenario activated")
end
local function range15_flag35()
  range_15_menu_flag35:Remove()
  trigger.action.setUserFlag(35, true)
  MessageToAll("R15 CAS scenario #2 activated")
end

local function range15_flag65()
  range_15_menu_flag65:Remove()
  trigger.action.setUserFlag(65, true)
  MessageToAll("Range 15 AR scenario activated")
end

range_15_menu_flag61 = MENU_MISSION_COMMAND:New("Activate R15 Basic CAS Scenario",range_15_menu_root,range15_flag61)
range_15_menu_flag35 = MENU_MISSION_COMMAND:New("Activate R15 CAS Scenario #2",range_15_menu_root,range15_flag35)
range_15_menu_flag65 = MENU_MISSION_COMMAND:New("Activate Range 15 AR Scenario",range_15_menu_root,range15_flag65)
