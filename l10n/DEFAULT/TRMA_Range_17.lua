...
local function range17_flag101()
  range_17_menu_ARscenario_Armored_Brigade:Remove()
  trigger.action.setUserFlag(101, true)
  MessageToAll("R17 AR scenario Armored Brigade activated")
end

range_17_menu_ARscenario_Armored_Brigade = MENU_MISSION_COMMAND:New("Activate AR scenario Armored Brigade",range_17_menu_root,range17_flag101)
